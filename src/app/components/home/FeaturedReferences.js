...
export default function FeaturedConferences() {
  ...
  const conferences = [
    {
      title: "International Conference on Computing & System Sciences (COMSYS)",
      subtitle: "Flagship Research Summit",
      date: "December 15-17, 2026",
      location: "New Delhi, India",
      description: "Bringing together global minds in artificial intelligence, cloud architectures, and next-generation data systems.",
      badge: "Flagship Event",
      border: "border-cyan-400/50",
    },
    {
      title: "Digital Economy & Commerce Symposium (ICDEC)",
      subtitle: "Global Innovation Forum",
      date: "March 20-22, 2027",
      location: "Bengaluru, India",
      description: "Exploring secure financial frameworks, blockchain applications, and sustainable digital market structures.",
      badge: "High Impact",
      border: "border-blue-400/50",
    },
    {
      title: "Advanced STEM & Social Trust Research Camp",
      subtitle: "Academic Workshop Series",
      date: "July 10-12, 2027",
      location: "Hybrid / Global",
      description: "Mentoring young researchers and bridging empirical survey data with practical societal transformation.",
  ...
  return (
    <section className="relative overflow-hidden py-32 bg-[#020617] text-white border-b border-cyan-500/40 perspective-[1200px]">
      ...
      {/* Full-Width Nuclear Spin Fusion Core (Spans entire width, clipped to bottom half) */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[1600px] h-[550px] pointer-events-none flex items-end justify-center z-0 opacity-55 overflow-hidden">
        ...
        {/* Outer Nuclear Spin Orbit 1 (Full Width) */}
        ...
        {/* Middle Nuclear Spin Orbit 2 (Reverse Spin) */}
        ...
        {/* Inner Fast Nuclear Spin Orbit 3 */}
        ...
        {/* Intense Central Nuclear Core Fusion Glow */}
      ...
      {/* Additional Ambient Neon Aurora Glows */}
